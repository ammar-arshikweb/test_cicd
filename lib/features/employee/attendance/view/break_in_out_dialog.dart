...
class BreakInOutDialog extends StatefulWidget {
  final DateTime time;
  final bool isBreakOut;

  const BreakInOutDialog({super.key, required this.time, required this.isBreakOut});

  @override
  State<BreakInOutDialog> createState() => _BreakInOutDialogState();
}

class _BreakInOutDialogState extends State<BreakInOutDialog> with SingleTickerProviderStateMixin {
                ...
                isSubmitted
                    ? Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Center(
                            child: Text(
                              widget.isBreakOut ? strings.break_out_successful : strings.break_in_successful,
                    ...
                    : Column(
                      ...
                      children: [
                        ...
                        Text(
                          widget.isBreakOut ? strings.are_you_sure_you_want_to_break_out : strings.are_you_sure_you_want_to_break_in,
                          textAlign: TextAlign.center,
                            ...
                            Expanded(
                              child: ElevatedButton(
                                ...
                                onPressed: () => GlobalTap.safeTap(() async {
                                  int isSuccess = 0;
                                  if (widget.isBreakOut) {
                                    isSuccess = await attendanceViewModel.setBreakTime(context, widget.time, true);
                                  } else {
                                    isSuccess = await attendanceViewModel.setBreakTime(context, widget.time, false);
                                  }
                                  if (isSuccess == 1) {
                                    setState(() {
                                      isSubmitted = true;
